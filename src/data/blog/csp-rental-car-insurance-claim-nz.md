...
核准 ≠ 自動入帳。要在 jpmorgan 信的 Action Needed By 前，填好收款帳戶的 routing／account 完成 ACH 設定（我只有 2 天，信還可能躺在垃圾郵件匣）。任何美國帳戶都行——我直接 ACH 到自己的 Capital One 360 Checking，設定完 2 天就入帳。**只有逾期沒設定，才會改開紙本支票寄美國地址**，台灣託收美金支票又慢又貴，所以能走 ACH 就別拖。
