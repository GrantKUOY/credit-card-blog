...
![左前輪拱被刮的白色 Hyundai Santa Fe，紅圈標示損傷位置](../../assets/images/csp-claim-damage-wide.jpg)

_就這麼一道——左前輪拱塑膠飾板被刮（紅圈處）。路邊停車回來才發現，沒目擊、原因不明，卻足以被圈走 NZD 1,000。_

![近拍輪拱刮痕，旁邊擺著這趟全程買單的 Chase Sapphire Preferred](../../assets/images/csp-claim-damage-closeup.jpg)
...
**硬性期限而且很短**——信上會寫 Action Needed By 哪天，我的是 6/19 晚上收信、6/21 截止，實際只有 2 天。逾期改開紙本支票寄到你 file 上的地址，又慢又麻煩，能走 ACH 就走 ACH。我當晚就完成設定，6/22 錢就進帳戶了。
...
**3. 核准後在期限內完成 ACH 領款（別拖到變支票）**

核准 ≠ 自動入帳。要在 jpmorgan 信的 Action Needed By 前，填好收款帳戶的 routing／account 完成 ACH 設定（我只有 2 天，信還可能躺在垃圾郵件匣）。任何美國帳戶都行——我直接 ACH 到自己的 Capital One 360 Checking，設定完 2 天就入帳。**只有逾期沒設定，才會改開紙本支票寄美國地址**（又慢又麻煩），所以能走 ACH 就別拖。
